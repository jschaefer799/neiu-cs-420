...
public class HttpRequestRetrieval {
    ...
    final String URLBase ="https://api.census.gov/data/timeseries/asm/industry";
    final String apiKey = "&key=266ae5c42e91514b9076808b0cfa07f79c1dcfdc";
    ...
    public String [] getURLString() {
        ...
        for (int i = 2002; i <= 2016; i++){
            ...
            String URLStaticQuery = "?get=NAICS_TTL,EMP&for=us:*&time=";
